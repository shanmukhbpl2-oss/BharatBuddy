...
const SYS = `You are BharatBuddy, India's most trusted AI life assistant. Speak in warm Hinglish. Be like a caring elder sibling. Help with medicine, expenses, schemes, legal, kisan, shopping, loans, family. Keep responses to 3-5 lines. Use emojis. For health say "Doctor se zaroor milein 🙏". Use ₹ for money.`;
...
// ── SERVICES ──────────────────────────────────────────────────
const SERVICES = [
  { id:"medicine",  icon:"💊", label:"दवाई",       sub:"Reminders",       color:C.red,    grad:"linear-gradient(135deg,#EF4444,#DC2626)", free:true  },
  { id:"expense",   icon:"💸", label:"खर्च",        sub:"Tracker",         color:C.orange, grad:"linear-gradient(135deg,#F97316,#EA580C)", free:true  },
  { id:"weather",   icon:"🌤",  label:"मौसम",        sub:"Forecast",        color:C.blue,   grad:"linear-gradient(135deg,#3B82F6,#2563EB)", free:true  },
  { id:"schemes",   icon:"🏛",  label:"Schemes",    sub:"28+ योजनाएं",     color:C.green,  grad:"linear-gradient(135deg,#10B981,#059669)", free:true  },
  { id:"family",    icon:"👨‍👩‍👧", label:"Family",    sub:"All Reminders",   color:C.pink,   grad:"linear-gradient(135deg,#EC4899,#DB2777)", free:false },
  { id:"finance",   icon:"🏦", label:"Finance",    sub:"EMI • Loans",      color:C.blue,   grad:"linear-gradient(135deg,#3B82F6,#1D4ED8)", free:false },
  { id:"shopping",  icon:"🛒", label:"Shopping",   sub:"Best Deals",       color:C.purple, grad:"linear-gradient(135deg,#8B5CF6,#7C3AED)", free:false },
  { id:"kisan",     icon:"🌾", label:"Kisan",      sub:"Mandi • Fasal",   color:C.teal,   grad:"linear-gradient(135deg,#14B8A6,#0F766E)", free:false },
  { id:"legal",     icon:"⚖",  label:"Legal",      sub:"Rights Guide",    color:"#94A3B8", grad:"linear-gradient(135deg,#64748B,#475569)", free:false },
  { id:"location",  icon:"📍", label:"Near Me",    sub:"Hospital • CSC",  color:C.teal,   grad:"linear-gradient(135deg,#06B6D4,#0891B2)", free:false },
  { id:"homework",  icon:"📚", label:"Homework",   sub:"Class 1-12",      color:C.blue,   grad:"linear-gradient(135deg,#6366F1,#4F46E5)", free:false },
  { id:"emergency", icon:"🚨", label:"Emergency",  sub:"108 • 112",       color:C.red,    grad:"linear-gradient(135deg,#EF4444,#B91C1C)", free:true  },
  { id:"report",    icon:"📊", label:"Report",     sub:"Monthly PDF",     color:C.orange, grad:"linear-gradient(135deg,#F59E0B,#D97706)", free:false },
  { id:"document",  icon:"📄", label:"Docs",       sub:"Aadhaar • PAN",   color:"#94A3B8", grad:"linear-gradient(135deg,#64748B,#334155)", free:false },
  { id:"news",      icon:"📰", label:"News",       sub:"Hindi Today",     color:C.blue,   grad:"linear-gradient(135deg,#0EA5E9,#0284C7)", free:true  },
  { id:"chat",      icon:"💬", label:"AI Chat",    sub:"Baat Karo",       color:C.green,  grad:"linear-gradient(135deg,#10B981,#047857)", free:true  },
];
